  ...
  return (
    <div id={id} class="relative">
      ...
      <div class="h-full absolute lg:h-[44px] w-full justify-between right-0 top-0 flex w-full gap-[12px] items-center">
        <div class="group">
          <Slider.PrevButton class="lg:absolute lg:top-[25%] lg:left-[32.43vw] w-[15px] h-[15px] lg:w-[33px] lf:h-[33px] flex justify-center items-center text-white bg-transparent no-animation">
            <Icon
              id="chevron-right"
              size={33}
        ...
        <div class="group">
          <Slider.NextButton class="lg:absolute lg:top-[25%] lg:right-[32.43vw] w-[15px] h-[15px] lg:w-[33px] lf:h-[33px] flex justify-center items-center text-white bg-transparent no-animation">
            <Icon
              id="chevron-right"
              size={33}
              class="fill-white"
